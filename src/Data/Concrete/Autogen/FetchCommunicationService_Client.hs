...
module Data.Concrete.Autogen.FetchCommunicationService_Client(fetch,getCommunicationIDs,getCommunicationCount) where
...
import Data.Concrete.Autogen.FetchCommunicationService
seqid = R.newIORef 0
