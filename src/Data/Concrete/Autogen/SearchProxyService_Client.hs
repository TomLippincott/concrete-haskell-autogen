...
module Data.Concrete.Autogen.SearchProxyService_Client(search,getProviders,getCapabilities,getCorpora) where
...
import Data.Concrete.Autogen.SearchProxyService
seqid = R.newIORef 0
